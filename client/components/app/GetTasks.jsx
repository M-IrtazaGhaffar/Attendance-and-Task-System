...
export default function GetTasks() {
  ...
  const fetchTasks = async () => {
    try {
      const res = await api.post("/gettaskstoday");
  ...
  return (
    <div className="flex flex-col gap-2">
      <p className="text-sm font-medium">All Tasks for today.</p>
      <ScrollArea className="h-[500px] w-full p-4 border rounded-2xl shadow-2xl">
