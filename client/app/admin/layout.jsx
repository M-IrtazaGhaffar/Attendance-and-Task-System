    ...
    return (
        <div className="flex min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6 gap-6">
            ...
            <div className="flex-1 bg-gradient-to-br from-white to-gray-50 shadow-xl rounded-2xl p-8 border border-gray-100">
                ...
                {/* Actions */}
                <div className="mt-6 flex flex-wrap items-center gap-3 h-fit">
                    <Link href={`/${role}/`}>
                    ...
                    <Link href={`/${role}/viewattendance`}>
                        <Button className="px-4 py-2 rounded-lg bg-black text-white font-medium hover:bg-gray-800 transition-colors shadow-md">
                            <FileStack />
                            View Attendance
                        </Button>
                    </Link>
                    <Link href={`/admin/viewattendancetoday`}>
                        <Button className="px-4 py-2 rounded-lg bg-black text-white font-medium hover:bg-gray-800 transition-colors shadow-md">
                            <FileStack />
                            View Attendance Today
                        </Button>
                    </Link>
                    <Link href={`/admin/viewattendancebyuserid`}>
                        <Button className="px-4 py-2 rounded-lg bg-black text-white font-medium hover:bg-gray-800 transition-colors shadow-md">
                            <FileStack />
                            View Attendance By User ID
                        </Button>
                    </Link>
                    <Link href={`/admin/viewattendanceofalltime`}>
                        <Button className="px-4 py-2 rounded-lg bg-black text-white font-medium hover:bg-gray-800 transition-colors shadow-md">
                            <FileStack />
                            View Attendance of All Time
                        </Button>
                    </Link>
                    <Link href={`/admin/viewattendancebydate`}>
                        <Button className="px-4 py-2 rounded-lg bg-black text-white font-medium hover:bg-gray-800 transition-colors shadow-md">
                            <FileStack />
                    ...
                    <Link href={`/admin/viewleaves`}>
                        <Button className="px-4 py-2 rounded-lg bg-black text-white font-medium hover:bg-gray-800 transition-colors shadow-md">
                            <FileStack />
                            View Leave Requests
                        </Button>
                    </Link>
                    <Link href={`/admin/viewleavesbyuserid`}>
                        <Button className="px-4 py-2 rounded-lg bg-black text-white font-medium hover:bg-gray-800 transition-colors shadow-md">
                            <FileStack />
                            View Leave Requests By User ID
                        </Button>
                    </Link>

                    |

                    <Link href={`/${role}/viewtasks`}>
                        <Button className="px-4 py-2 rounded-lg bg-black text-white font-medium hover:bg-gray-800 transition-colors shadow-md">
                            <ListTodo />
                            View Tasks
                        </Button>
                    </Link>
                    <Link href={`/admin/createtasks`}>
                        <Button className="px-4 py-2 rounded-lg bg-black text-white font-medium hover:bg-gray-800 transition-colors shadow-md">
                            <ListTodo />
                            Create Tasks
                        </Button>
                    </Link>
                    <Link href={`/admin/viewalltasks`}>
                        <Button className="px-4 py-2 rounded-lg bg-black text-white font-medium hover:bg-gray-800 transition-colors shadow-md">
                            <ListTodo />
                            View All Tasks
                        </Button>
                    </Link>
                    <Link href={`/admin/updatetask`}>
                        <Button className="px-4 py-2 rounded-lg bg-black text-white font-medium hover:bg-gray-800 transition-colors shadow-md">
                            <ListTodo />
                            Update Task
                        </Button>
